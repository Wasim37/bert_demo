...
LastEditTime: 2021-09-07 15:59:24
LastEditors: your name
Description: In User Settings Edit
FilePath: \bert-shizhan\code_18_pipline.py
'''
# -*- coding: utf-8 -*-
"""
...
print(
    nlp_fill(
        f"Li Jinhong wrote many {nlp_fill.tokenizer.mask_token} about artificial intelligence technology and helped many people."
    ))
